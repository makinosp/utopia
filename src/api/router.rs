...
use crate::api::handlers::tokens::{bootstrap_issue_token_handler, issue_token_handler, revoke_token_handler};
...
pub fn build_router(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        .merge(protected)
        .route("/api/v1/bootstrap/tokens", post(bootstrap_issue_token_handler))
