...
## Project Information
- **Project**: Firefly III互換APIの現状を棚卸しして、実装済み仕様と本家との差分、今後の優先順位を整理したい。
- **Project Description Source**: project-description.json
- **Project Type**: Brownfield
- **Scope**: firefly-compat-inventory
- **Start Date**: 2026-08-29T05:15:14Z
- **State Version**: 8
...
## Scope Configuration
- **Stages to Execute**: 0.1, 0.2, 0.3, 1.1, 2.1, 2.3
...
## Workspace State
- **Project Root**: /home/sheeptech/projects/utopia
- **Languages**: Rust
- **Frameworks**: Unknown
...
- **Next Stage**: none
- **Status**: Completed
- **Last Updated**: 2026-08-29T12:08:07Z
